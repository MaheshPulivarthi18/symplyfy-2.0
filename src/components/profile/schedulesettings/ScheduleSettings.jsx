      ...
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Alert>
              <AlertDescription>
                Cancellation charges will be applied to the patient if an appointment is cancelled/rescheduled within {form.watch('cancellation_penalty_value')} hours
              </AlertDescription>
            </Alert>
            <FormField
              control={form.control}
            ...
            />
            <Button type="submit" className="mt-6">Update Settings</Button>
          </form>
        </Form>
      </CardContent>
    </Card>
